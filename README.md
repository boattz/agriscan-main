...
**แหล่งอ้างอิง:** กรมพัฒนาที่ดิน, *คู่มือการวิเคราะห์ดินทางเคมีเพื่อประเมินความอุดมสมบูรณ์ของดิน*, ตารางที่ 15 (กองสำรวจดิน, 2523) — https://e-library.ldd.go.th/library/flip/bib10134f
...
3. เปิด URL ที่ได้ เช่น `https://agriscan-backend-xxxx.onrender.com/` — จะเห็นหน้า dashboard
...
const char* API_KEY   = "<ค่า API_KEY จาก Render>";
```
